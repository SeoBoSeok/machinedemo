...
$routes->post('pages-qa-update', 'PageController::show_pages_qa_update');
...
$routes->get('form-advanced-site', 'ComponentController::show_form_advanced_site');
$routes->get('form-advanced-machine', 'ComponentController::show_form_advanced_machine');
$routes->get('form-advanced-cell', 'ComponentController::show_form_advanced_cell');
...
$routes->get('charts-apex-log', 'ComponentController::show_charts_apex_log');
$routes->get('charts-echart', 'ComponentController::show_charts_echart');
$routes->get('charts-echart-machine', 'ComponentController::show_charts_echart_machine');
