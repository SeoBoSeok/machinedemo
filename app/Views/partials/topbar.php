                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <ul class="list-unstyled megamenu-list">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);" key="t-calendar"><?= lang('Files.Calendar') ?></a>
                                        </li>
                                        <li>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="assets/images/kkimm_logo.png" alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1" key="t-henry">KIMM</span>
