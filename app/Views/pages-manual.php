...
<body>
    ...
    .manual_list a {min-width: 270px; text-align: center; color: #000!important; display: inline-block!important; background-color: #e9e9e9!important; padding-bottom: 20px;}
    </style>
  ...
  <div class="navbar shadow-sm">
    <div class="container">
      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-item on"><a href="#" class="nav-link">Manuel</a></li>
